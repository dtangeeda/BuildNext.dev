  ...
  const [isMobileMenuOn, setIsMobileMenuOn] = useState(false)
    ...
    return (
      ...
      <div className="relative bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
            ...
            <div className="-mr-2 -my-2 md:hidden">
              <button type="button" onFocus={() => setIsMobileMenuOn(!isMobileMenuOn)} className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
            ...
            <nav className="hidden md:flex space-x-10">
              <div className="relative">
                ...
                <button type="button" onBlur={() => setIsOn(!isOn)} onFocus={() => setIsOn(!isOn)} className="group bg-white rounded-md text-gray-500 inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                  <span>Services</span>
                  {/*
          ...
          */}
                <div className={` ${isOn ? 'opacity-100' : 'hidden opacity-0'} absolute z-20 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2 `}>
              ...
              <div className="relative">
                {/* Item active: "text-gray-900", Item inactive: "text-gray-500" */}
                <button type="button" onBlur={() => setIsMoreOn(!isMoreOn)} onFocus={() => setIsMoreOn(!isMoreOn)} className="group bg-white rounded-md text-gray-500 inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                  <span>More</span>
                  {/*
              Heroicon name: chevron-down
            ...
            */}
            ...
            Leaving: "transition ease-in duration-150"
              ...
              To: "opacity-0 translate-y-1"
          */}
                <div className={` ${isMoreOn ? 'opacity-100' : 'hidden opacity-0'} absolute z-30 left-1/2 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md sm:px-0 `}>
                  <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                    <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                      <a href="/support" className="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
        ...
        */}
        <div className={` ${isMobileMenuOn ? 'opacity-100' : 'hidden opacity-0'} absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden z-50`} >
